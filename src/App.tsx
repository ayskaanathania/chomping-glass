...
const PROGRAM_ID = new PublicKey(
  "5K49Sp61fPWmUveEFWPmofgW7hgX2H8UqZGhVMNoSgpA"
);
...
function App() {
  ...
  const handleClick = async (index: number) => {
    ...
    if (connection.rpcEndpoint.includes("localhost")) {
      console.log(
        `https://explorer.solana.com/tx/${signature}?cluster=custom&customUrl=https%3A%2F%2Fstaging-rpc.dev2.eclipsenetwork.xyz`
      );
    } else {
